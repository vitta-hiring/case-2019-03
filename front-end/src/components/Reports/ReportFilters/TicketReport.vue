    ...
    <div class="flex-column">
      <div class="flex width-100 flex-column-600">
        <div class="width-25 flex flex-column width-100-600 margin-10-t-600">
          <label class="f-12-500-gray-medium padding-5-b">
            {{$t('report.filter.ticket').toUpperCase()}}
          </label>
          <input
        ...
        <div class="width-25 flex flex-column width-100-600 margin-10-t-600">
          <label class="f-12-500-gray-medium padding-5-b">
            {{$t('report.list.client').toUpperCase()}}
          </label>
          <input
            name="filter.ticketNumber"
        ...
        <div class="width-25 flex flex-column width-100-600 margin-10-t-600">
          <label class="f-12-500-gray-medium padding-5-b">
            {{$t('report.list.user').toUpperCase()}}
          </label>
          <input
            name="filter.ticketNumber"
            v-model="query.user"
        ...
        <div class="width-25 flex flex-column width-100-600 margin-10-t-600">
          <label class="f-12-500-gray-medium padding-5-b">
            {{$t('report.list.agent').toUpperCase()}}
          </label>
          <input
            name="filter.ticketNumber"
            v-model="query.agent"
      ...
      <div class="flex width-100 flex-column-470">
        <div class="width-50 width-100-470 margin-10-t flex-column">
          <label class="f-12-500-gray-medium padding-5-b">
            {{$t('report.list.openDate').toUpperCase()}}
          </label>
          <div>
            <VueHotelDatepicker
        ...
        <div class="width-50 width-100-470 margin-10-t flex-column">
          <label class="f-12-500-gray-medium padding-5-b">
            {{$t('report.list.closeDate').toUpperCase()}}
          </label>
          <div>
            <VueHotelDatepicker
              :placeholder="this.localeRangeData.placeholder"
